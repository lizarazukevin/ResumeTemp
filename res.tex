...
\begin{document}
    ...
    \begin{resSection}{Projects}
        ...
        \addDesc{Trained Naive Bayes [57\%], Support Vector Machine [87\%], and ChatGPT models on a 45k article dataset (real and fake) from Kaggle, prepared using a bag-of-words approach with a 90/10 split on Python and Pandas dataframe}
