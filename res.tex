...
\begin{document}
    ...
    \begin{resSection}{Skills}
        \addSkill{\textbf{Languages:} Python \hspace{-.3ex}{\includegraphics[height=1em]{icons/fullp.png}}, 
        ...
        \addSkill{\textbf{Packages:} NumPy, SciPy, Tkinter, RayLib, Pandas, OpenCV, AIGym, SciKit-Learn, Regex}
        \addSkill{\textbf{Development:} Qt, Docker, Git, Tensorflow, PyTorch, Linux, Anaconda, GDB, Valgrind, Kaggle, Unity, Unreal Engine}
